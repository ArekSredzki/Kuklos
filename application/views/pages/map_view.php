            ...
            <div class="container text-center">
                ...
                <div class="row">
                    <ul class="other-info list-unstyled col-md-6 col-sm-10 col-xs-12 col-md-offset-3 col-sm-offset-1 xs-offset-0" >
                        <li><i class="fa fa-envelope-o"></i><a href="contact.html#">hello@yourwebsite.com</a></li>
        ...
        <section id="cta-section" class="section cta-section text-center contact-cta-section">
            <div class="container">
               ...
               <p><a class="btn btn-cta btn-cta-primary" href="../website-templates/responsive-bootstrap-theme-for-products-velocity/index.html" target="_blank">Get Velocity Now</a></p>
            </div><!--//container-->
        </section><!--//cta-section-->