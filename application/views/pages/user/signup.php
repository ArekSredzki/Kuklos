                            ...
                            <div class="row">
                                ...
                                <div class="social-btns col-md-5 col-sm-12 col-xs-12 col-md-offset-1 col-sm-offset-0 col-sm-offset-0">  
                                    ...
                                    <ul class="list-unstyled social-login">
                                        <li><a class="facebook-btn btn" href="<?php echo base_url('user/connect/facebook'); ?>"><i class="fa fa-facebook"></i>Sign up with Facebook</a></li>
                                        <li><a class="github-btn btn" href="<?php echo base_url('user/connect/github'); ?>"><i class="fa fa-github-alt"></i>Sign up with Github</a></li>
                                        <li><a class="google-btn btn" href="<?php echo base_url('user/connect/google'); ?>"><i class="fa fa-google-plus"></i>Sign up with Google</a></li>
                                    </ul>
