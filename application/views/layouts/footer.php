                ...
                <div class="row">                    
                    <div class="footer-col links col-md-2 col-sm-4 col-xs-12">
                        <div class="footer-col-inner">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="index.html#"><i class="fa fa-caret-right"></i>Who we are</a></li>
                                <li><a href="index.html#"><i class="fa fa-caret-right"></i>Press</a></li>
                                <li><a href="index.html#"><i class="fa fa-caret-right"></i>Blog</a></li>
                                <li><a href="index.html#"><i class="fa fa-caret-right"></i>Jobs</a></li>
                                <li><a href="index.html#"><i class="fa fa-caret-right"></i>Contact us</a></li>
                            </ul>
                    ...
                    <div class="footer-col links col-md-2 col-sm-4 col-xs-12">
                        <div class="footer-col-inner">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="index.html#"><i class="fa fa-caret-right"></i>How it works</a></li>
                                <li><a href="index.html#"><i class="fa fa-caret-right"></i>API</a></li>
                                <li><a href="index.html#"><i class="fa fa-caret-right"></i>Download Apps</a></li>
                                <li><a href="index.html#"><i class="fa fa-caret-right"></i>Pricing</a></li>
                            </ul>
                        </div><!--//footer-col-inner-->
                    </div><!--//foooter-col-->              
